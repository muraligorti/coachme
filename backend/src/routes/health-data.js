...
// ── OAUTH CONFIG ──
// NOTE: Google Fit is intentionally NOT listed here. Google stopped issuing
// new Google Fit API client credentials in May 2024 and is shutting the API
// down entirely by end of 2026 — any new integration attempt would fail.
// The frontend instead points users at Health Connect (Android's official
// replacement), which requires the native app, not a web OAuth flow.
const OAUTH_CONFIG = {
  fitbit: {
