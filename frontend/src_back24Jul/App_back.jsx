...
const ST=({children,right})=>{
  ...
  return<div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:16,gap:8,flexWrap:"wrap"}}>
    <h2 style={{color:C.tx,fontSize:20,margin:"6px 0",fontWeight:700,flexShrink:0}}>{children}</h2>
