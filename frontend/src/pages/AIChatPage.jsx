...
- Check-ins: BOTH the client and their coach can log a check-in (mood/energy/sleep/stress/adherence/weight) — coaches can log one live during a session
- Invoicing: real invoices with optional Razorpay payment links (each coach connects their own Razorpay account in Settings) — no in-app checkout, links are shared manually (e.g. via WhatsApp)
- Notifications: local on-device reminders for sessions/check-ins/habits/nutrition, configurable in Settings
